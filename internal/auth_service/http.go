...
func RegisterRoutes(mux *http.ServeMux, h *Handler) {
	handledFuncs := map[string]http.HandlerFunc{
		"POST /api/user":        h.AuthUser,
		"POST /api/user/reg":    h.RegisterUser,
		"POST /api/user/update": h.UpdateUserPasswd,
		"POST /api/user/jwt":    h.UpdateJWTUser,

		"POST /api/staff":        h.AuthStaff,
		"POST /api/staff/reg":    h.RegisterStaff,
		"POST /api/staff/update": h.UpdateStaffPasswd,
		"POST /api/staff/jwt":    h.UpdateJWTStaff,
	}
